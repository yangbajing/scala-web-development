...
object Mocks {
  ...
  private def createContext() = {
    ...
    c.evaluateString(scope, Api.functionFakeList, "<Api.functionFakeList>", 1, null)
    c -> scope
  }

  private def formatJsonString(objStr: String, replacer: String = null, space: Int = 0): String = {
